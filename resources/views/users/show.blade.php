        ...
        <div class="tab-pane fade show active" id="tab-personal" role="tabpanel">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('users.edit', $user->id) }}" class="btn btn-outline-dark btn-sm" data-bs-toggle="tooltip" title="Ubah Detail">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="fw-bold">{{ $user->start_date ?? '-' }}</div>
                        </div>
                        <div class="col-md-4">
                            <div class="text-muted small">Status</div>
                            <div class="fw-bold">{{ $user->employment_status ?? '-' }}</div>
                        </div>

                        <div class="col-md-4 mt-3">
                            <div class="text-muted small">Gaji Pokok</div>
                            <div class="fw-bold">Rp {{ number_format($user->salary, 0, ',', '.') }}</div>
                        </div>

                        <div class="col-md-4 mt-3">
                            <div class="text-muted small">Tanggal Berakhir</div>
                            <div class="fw-bold">{{ $user->end_date ?? '-' }}</div>
                        </div>

                        <div class="col-md-4 mt-3">
                            <div class="text-muted small">Dokumen Kontrak</div>
                            @if ($user->contract_letter_file)
                                <a href="{{ asset('storage/contracts/' . $user->contract_letter_file) }}"
